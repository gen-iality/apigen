...
class Message extends Moloquent
{
    ...
    protected $fillable = ['subject', 'server_message_id', 'total_delivery', 'total_clicked', 'total_bounced', 'total_opened', 'total_complaint', 'message', 'footer', 'image', 'number_of_recipients'];
    /**
