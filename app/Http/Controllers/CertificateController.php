    ...
    public function generateCertificate(Request $request){
        ...
        foreach($contentqry as $datos){
            ...
            if ($request->get('download') == '1') {
                ...
                $data['content'] = '<p><br></p> <p> </p><h3 style="font-size:1.8em;">CERTIFICADO DE ASISTENCIA</h3><p></p> <br> <p style="margin-top:-3%;"><span style="font-weight: 400; font-size: 14pt;"><br></span></p> <p style="font-size:1.3em">Certificamos que&nbsp;<span style="font-style: normal; font-weight: bold;">'.$cedula->{"names"}.'</span> , identificada con el No. de cédula<br> <span style="font-style: normal; font-weight: bold;" class="iden">'.$cedula->{"identificacion"}.'</span> participó con éxito en calidad de asistente&nbsp;<span style="font-style: normal; font-weight: bold;"><br class="eventName">VIII Congreso Internacional de Gerencia de Proyectos Bogotá 2019</span></p><br><p style="">BOGOTÁ, COLOMBIA</p> <div style="position:absolute;bottom: 620px;left:-1440px"><span style="font-style: normal; font-weight: bold;font-size:1.3em">DOMINICA MARTÍNEZ</span><p>presidente Congreso Internacional de<br>Gerencia de Proyectos</p></div> <div style=" position:absolute;bottom:680px;right:-1540px;"><span style="font-style:normal;font-weight: bold;font-size:1.3em">CLAUDIA TRUJILLO</span><p>presidente PMI - 2019</p></div>';
                $pdf = PDF::loadview('Public.ViewEvent.Partials.certificate', $data);
