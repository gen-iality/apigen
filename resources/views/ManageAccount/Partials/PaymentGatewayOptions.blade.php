        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::selectRange('percentage_discount', 0, 100, null, array('class'=>'control-label required')) !!} %
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    {!! Form::label('tickets_discount', trans("ManageAccount.tickets_discount"), array('class'=>'control-label required')) !!}
                    {!! Form::selectRange('tickets_discount', 0, 20, null, array('class'=>'control-label required')) !!}
                </div>
            </div>
        </div>
