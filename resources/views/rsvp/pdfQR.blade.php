...
<div class="container">
  <div class="item">
    ...
    <img class="qr" src="data:image/png;base64,{{$qr['code']}}" />
    ...
    <div class="item-left">
      <p class="event">{{$organization->name}}</p>
      ...
      <div class="sce">
        ...
        <p>Início: {{$event->datetime_from}} <br/>Fín: {{$event->datetime_to}}</p>
      </div>
      <div class="fix"></div>
      <div class="loc">
        <div class="icon">
          <p><i class="fa fa-hashtag"></i> Orden: {{$order->_id}}</p>
	</div>
      </div>
      <div class="fix"></div>
      <p class="tickets">{{$qr['name_ticket']}}</p>
    </div> 
  </div>
</div>
