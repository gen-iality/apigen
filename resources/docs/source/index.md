...
```bash
curl -X POST \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/duplicateactivitie/accusamus" \
...
```bash
curl -X POST \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/createmeeting/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"activity_datetime_start":"2020-10-14 14:11","activity_name":"quo","activity_description":"in"}'
...
```bash
curl -X PUT \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/activities/aut/hostAvailability" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
...
```bash
curl -X POST \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/activities/eveniet/register_and_checkin_to_activity" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/activities/mettings_zoom/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/activities" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/activities"
);
...
```json
{
    "data": [
        {
            "_id": "61a687746b180e0f0c1fa2d2",
            "name": "Demo",
            "subtitle": null,
            "image": null,
            "description": null,
            "capacity": 100,
            "event_id": "61a687713bbf847b3f59d117",
            "datetime_end": "2021-11-30 16:18:00",
            "datetime_start": "2021-11-30 15:18:00",
            "date_start_zoom": "2021-11-30T14:18:00",
            "date_end_zoom": "2021-11-30T17:18:00",
            "updated_at": "2021-11-30 20:20:04",
            "created_at": "2021-11-30 20:20:04",
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/activities/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/activities/1"
);
...
```bash
curl -X POST \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/activities/cumque/checkinbyadmin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"user_id":"quisquam"}'
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/activities_attendees" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/activities_attendees"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/activities_attendees/5ed66ce2a6929562725bd7c2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/activities_attendees/5ed66ce2a6929562725bd7c2"
);
...
```bash
curl -X PUT \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/activities_attendees/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/me/events/61a687713bbf847b3f59d117/activities_attendees" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/me/events/61a687713bbf847b3f59d117/activities_attendees"
);
...
```bash
curl -X PUT \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/activities_attendees/ut/check_in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/comments/organizations/61fc3d08cc30801701328123" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/comments/organizations/61fc3d08cc30801701328123"
);
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"organization_id":"et","comment":"explicabo","image":"repellat"}'
...
```bash
curl -X PUT \
    "https://api.evius.co/api/comments/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/comments" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "https://api.evius.co/api/discountcodetemplate/aperiam/code/vel" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/code/codesByUser?organization=mollitia&email=ut" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/code/codesByUser"
);
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"Curso de regalo","use_limit":1,"discount":100,"event_id":"5ea23acbd74d5c4b360ddde2","organization_id":"5e9caaa1d74d5c2f6a02a3c3","discount_type":"quidem"}'
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/discountcodetemplate/findByOrganization/61fc3d08cc30801701328123" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/discountcodetemplate/findByOrganization/61fc3d08cc30801701328123"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/documentusers" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/documentusers"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/documentusers/tempora" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/documentusers/tempora"
);
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"eum","url":"perferendis","assign":false}'
...
```bash
curl -X PUT \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/documentusers/sapiente" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/documentusers/voluptatum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/me/documentusers" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/me/documentusers"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/documents" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/documents"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/documents/debitis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/documents/debitis"
);
...
```json
{
    "message": "No query results for model [App\\Documents] debitis"
}
```
...
```bash
curl -X PUT \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/documents/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"gato.jpg","title":"gato.jpg","format":"jpg","type":"file","file":"https:\/\/firebasestorage.googleapis.com\/v0\/b\/eviusauth.appspot.com\/o\/documents%2F61a65a6c47430f7aae79cca4%2F1639168484513-gato4.jpg?alt=media&token=1455a85f-6381-4a92-a00e-47c916ed236c"}'
...
```bash
curl -X DELETE \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/documents/eligendi" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/events" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/events"
);
...
```json
{
    "data": [],
    "links": {
        "first": "http:\/\/localhost\/api\/organizations\/61fc3d08cc30801701328123\/events?page=1",
        "last": "http:\/\/localhost\/api\/organizations\/61fc3d08cc30801701328123\/events?page=1",
        "prev": null,
        "next": null
    },
    "meta": {
        ...
        "from": null,
        "last_page": 1,
        "path": "http:\/\/localhost\/api\/organizations\/61fc3d08cc30801701328123\/events",
        "per_page": 2500,
        "to": null,
        "total": 0
    }
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/eventsstadistics" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/eventsstadistics"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events?filtered=%5B%7B%22field%22%3A%22name%22%2C%22value%22%3A%5B%22Demo%22%5D%7D%5D" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117"
);
...
curl -X PUT \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"Demo","adress":"Avenida siempre viva","datetime_from":"2020-10-16 18:00:00","datetime_to":"2020-10-16 21:00:00","type_event":"laboriosam","picture":"cupiditate","venue":"Venue B","location":{},"visibility":"PUBLIC","user_properties":[],"description":"Evento para mostrel funcionamiento de la plataforma.","event_type_id":"5bf47226754e2317e4300b6a","organizer_id":"5e9caaa1d74d5c2f6a02a3c3","category_ids":[],"styles":{}}'
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"Demo","adress":"Avenida siempre viva","datetime_from":"2020-10-16 18:00:00","datetime_to":"2020-10-16 21:00:00","type_event":"in","picture":"sequi","venue":"Venue B","location":{"Latitude":4.668184,"Longitude":-74.051968,"number":"#123","street":"Avenida siempre viva","city":"Bogot\u00e1","state":"Bogot\u00e1 D.C","FormattedAddress":"Av. Siempre viva #123, Bogot\u00e1, Colombia"},"visibility":"PUBLIC","user_properties":[],"description":"Evento para mostrel funcionamiento de la plataforma.","event_type_id":"5bf47226754e2317e4300b6a","organizer_id":"5e9caaa1d74d5c2f6a02a3c3","category_ids":[],"styles":{"buttonColor":"#FFF","banner_color":"#FFF","menu_color":"#FFF","brandPrimary":"#FFFFFF","brandSuccess":"#FFFFFF","brandInfo":"#FFFFFF","brandDanger":"#FFFFFF","containerBgColor":"#FFFFFF","brandWarning":"#FFFFFF","brandDark":"#FFFFFF","brandLight":"#FFFFFF","textMenu":"#555352","activeText":"#FFFFFF","bgButtonsEvent":"#FFFFFF"}}'
...
```bash
curl -X PUT \
    "https://api.evius.co/api/user/events/61a687713bbf847b3f59d117" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"Demo","adress":"Avenida siempre viva","datetime_from":"2020-10-16 18:00:00","datetime_to":"2020-10-16 21:00:00","type_event":"laborum","picture":"exercitationem","venue":"Venue B","location":{},"visibility":"PUBLIC","user_properties":[],"description":"Evento para mostrel funcionamiento de la plataforma.","event_type_id":"5bf47226754e2317e4300b6a","organizer_id":"5e9caaa1d74d5c2f6a02a3c3","category_ids":[],"styles":{}}'
...
```bash
curl -X PUT \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/changeStatusEvent" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"status":"approved"}'
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/eventsbeforetoday?filtered=%5B%7B%22field%22%3A%22name%22%2C%22value%22%3A%5B%22Demo%22%5D%7D%5D" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/eventsbeforetoday"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/eventsaftertoday?filtered=%5B%7B%22field%22%3A%22name%22%2C%22value%22%3A%5B%22Demo%22%5D%7D%5D" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/eventsaftertoday"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/users/iusto/events" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/users/iusto/events"
);
...
```json
{
    "data": [],
    "links": {
        "first": "http:\/\/localhost\/api\/users\/iusto\/events?page=1",
        "last": "http:\/\/localhost\/api\/users\/iusto\/events?page=1",
        "prev": null,
        "next": null
    },
    "meta": {
        ...
        "from": null,
        "last_page": 1,
        "path": "http:\/\/localhost\/api\/users\/iusto\/events",
        "per_page": 2500,
        "to": null,
        "total": 0
    }
...
```bash
curl -X POST \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/surveys/1/coursefinished" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/adddocumentuser" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"quantity":25324674.791084684,"auto_assign":true}'
...
```bash
curl -X POST \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/eventusers" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/eventusers/1/unsubscribe" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/eventusers/1/unsubscribe"
);
...
```bash
curl -X POST \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/adduserwithemailvalidation" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
...
```bash
curl -X POST \
    "https://api.evius.co/api/eventusers/61a687713bbf847b3f59d117/tranfereventuser/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "https://api.evius.co/api/eventUsers/1/withStatus" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "https://api.evius.co/api/eventUsers/officiis/checkin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "https://api.evius.co/api/eventUsers/createUserAndAddtoEvent/61a687713bbf847b3f59d117" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"email":"example@evius.co","name":"Evius","password":"*******","other_params":{"city":"est"}}'
...
```bash
curl -X POST \
    "https://api.evius.co/api/eventUsers/bookEventUsers/61a687713bbf847b3f59d117" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"eventUsersIds":[]}'
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/eventusers" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
    ...
    "data": [
        {
            ...
            "private_reference_number": "947010789",
            "updated_at": "2021-11-30 20:20:01",
            "created_at": "2021-11-30 20:20:01",
            "user": {
                "_id": "61a685292e66fd61921378f2",
                "email": "geraldine.garcia+doc@mocionsoft.com",
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/eventusers/61ccd3551c821b765a312866" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/eventusers/61ccd3551c821b765a312866"
);
...
curl -X PUT \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"rol_id":"quia","properties":{"other_properties":"fugit"}}'
...
```bash
curl -X DELETE \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/eventusers/61ccd3333821b765a312866" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/me/eventusers/event/61a687713bbf847b3f59d117" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/me/eventusers/event/61a687713bbf847b3f59d117"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/eventusers/event/61a687713bbf847b3f59d117/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/eventusers/event/61a687713bbf847b3f59d117/user/1"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/me/events/61a687713bbf847b3f59d117/eventusers" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/me/events/61a687713bbf847b3f59d117/eventusers"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/metricsbydate/eventusers?metrics_type=created_at&datetime_from=minima&datetime_to=voluptatibus" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/metricsbydate/eventusers"
);

let params = {
    "metrics_type": "created_at",
    "datetime_from": "minima",
    "datetime_to": "voluptatibus",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X PUT \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/eventusers/animi/updaterol" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"rol_id":"dicta"}'
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/me/eventUsers" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/me/eventUsers"
);
...
```bash
curl -X POST \
    "https://api.evius.co/api/files/uploadbase/nostrum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"file":"voluptatem","type":"quis"}'
...
```bash
curl -X POST \
    "https://api.evius.co/api/googleanalytics" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/host" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/host"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/host/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/host/1"
);
...
```bash
curl -X POST \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/newsfeed" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
...
```bash
curl -X PUT \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/newsfeed/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"title":"Los mejores eventos est\u00e1n en Evius","description_complete":"Los eventos en evius son interactivos porque tiene multiples opciones...","description_short":"Los eventos en Evius son los m\u00e1s interactivos y los mejores.","linkYoutube":"https:\/\/www.youtube.com\/watch?v=m1YUmZRfgqU&ab_channel=MG1010","image":"https:\/\/storage.googleapis.com\/eviusauth.appspot.com\/evius\/events\/IdKxqboMxU0pvgY3AbRkig4ZptQcUNE4CUvysJIn.png","time":"2021-08-02"}'
...
```bash
curl -X DELETE \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/newsfeed/6107fe65ff324f482d1c7569" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/newsfeed" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```json
{
    "data": [],
    "links": {
        "first": "http:\/\/localhost\/api\/events\/61a687713bbf847b3f59d117\/newsfeed?page=1",
        "last": "http:\/\/localhost\/api\/events\/61a687713bbf847b3f59d117\/newsfeed?page=1",
        "prev": null,
        "next": null
    },
    "meta": {
        ...
        "from": null,
        "last_page": 1,
        "path": "http:\/\/localhost\/api\/events\/61a687713bbf847b3f59d117\/newsfeed",
        "per_page": 2500,
        "to": null,
        "total": 0
    }
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/newsfeed/6107fe65ff324f482d1c7569" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/orders/ordersevent?filtered=%5B%7B%22field%22%3A%22items%22%2C%22value%22%3A%226116b372396b8f5e864f033a%22%7D%5D" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/orders/ordersevent"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/orders/ad/orderOrganization" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/orders/ad/orderOrganization"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/organizations" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/organizations/61fc3d08cc30801701328123" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123"
);
...
```json
{
    "message": "No query results for model [App\\Organization] 61fc3d08cc30801701328123"
}
```
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"sit","styles":[],"user_properties":[]}'
...
curl -X PUT \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"facilis","styles":[],"user_properties":[]}'
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/organization/61fc3d08cc30801701328123/ordersUsersPoints?status=pendiente&date_from=dolor&date_to=perspiciatis&type_report=csv" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/organization/61fc3d08cc30801701328123/ordersUsersPoints"
);

let params = {
    "status": "pendiente",
    "date_from": "dolor",
    "date_to": "perspiciatis",
    "type_report": "csv",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/organizationusers" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/organizationusers"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/organizationusers/maiores" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/organizationusers/maiores"
);
...
```bash
curl -X PUT \
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/organizationusers/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/organizationusers/recusandae" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/me/organizations" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/me/organizations"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/me/organizations/61fc3d08cc30801701328123" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/me/organizations/61fc3d08cc30801701328123"
);
...
```bash
curl -X POST \
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/addorganizationuser" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/userproperties" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/userproperties"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/userproperties/laboriosam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/userproperties/laboriosam"
);
...
```bash
curl -X PUT \
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/userproperties/laudantium" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"celular","mandatory":true,"visibleByContacts":true,"visibleByAdmin":true,"label":"Celular","description":"N\u00famero de contacto","type":"number","justonebyattendee":true,"order_weight":1}'
...
```bash
curl -X DELETE \
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/userproperties/repudiandae" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/products" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
...
```bash
curl -X PUT \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/products/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
...
```bash
curl -X DELETE \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/products/sed" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/products/60e8cd558c421b004f2ff082/silentauctionmail" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/products" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/products/cum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/products/cum"
);
...
```bash
curl -X POST \
    "https://api.evius.co/api/rsvp/sendeventrsvp/61a687713bbf847b3f59d117" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"subject":"minima","image_header":"porro","content_header":"Has sido invitado a el evento","message":"aut","image":"laboriosam","image_footer":"sed","eventUsersIds":{"":"\"eventUsersIds\": [\"5f8734c81730821f216b6202\"]"},"include_ical_calendar":false,"include_login_button":false}'
...
```bash
curl -X PUT \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/updateStatusMessageUser/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/roles" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/roles"
);
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"placeat","type":"asperiores","module":"aut"}'
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/roles/aperiam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/roles/aperiam"
);
...
```bash
curl -X PUT \
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/roles/ex" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"unde","model":"exercitationem"}'
...
```bash
curl -X DELETE \
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/roles/error" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```json
{
    "message": "No query results for model [App\\RolEvent] 1"
}
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/rolesattendees" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/rolesattendees"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/rolesattendees/5faefba6b68d6316213f7cc2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/rolesattendees/5faefba6b68d6316213f7cc2"
);
...
```bash
curl -X PUT \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/rolesattendees/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "https://api.evius.co/api/rolesattendees/autem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/surveys/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/surveys/1"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/surveys" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/surveys"
);
...
```json
{
    "data": [],
    "links": {
        "first": "http:\/\/localhost\/api\/events\/61a687713bbf847b3f59d117\/surveys?page=1",
        "last": "http:\/\/localhost\/api\/events\/61a687713bbf847b3f59d117\/surveys?page=1",
        "prev": null,
        "next": null
    },
    "meta": {
        ...
        "from": null,
        "last_page": 1,
        "path": "http:\/\/localhost\/api\/events\/61a687713bbf847b3f59d117\/surveys",
        "per_page": 2500,
        "to": null,
        "total": 0
    }
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"survey":"Nombre de encuesta","show_horizontal_bar":false,"allow_vote_value_per_user":false,"activity_id":"ipsa","points":1,"initialMessage":"soluta","time_limit":0,"allow_anonymous_answers":false,"allow_gradable_survey":false,"hasMinimumScore":false,"isGlobal":false,"freezeGame":false,"open":false,"publish":false,"minimumScore":40017353.835514}'
...
curl -X PUT \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"survey":"qui","show_horizontal_bar":"sed","allow_vote_value_per_user":"sequi","activity_id":"sint","points":"repellendus","initialMessage":"alias","time_limit":"autem","allow_anonymous_answers":"eos","allow_gradable_survey":"ut","hasMinimumScore":"omnis","isGlobal":"sit","freezeGame":"officia","open":"dicta","publish":"omnis","minimumScore":"aut"}'
...
let body = {
    "survey": "qui",
    "show_horizontal_bar": "sed",
    "allow_vote_value_per_user": "sequi",
    "activity_id": "sint",
    "points": "repellendus",
    "initialMessage": "alias",
    "time_limit": "autem",
    "allow_anonymous_answers": "eos",
    "allow_gradable_survey": "ut",
    "hasMinimumScore": "omnis",
    "isGlobal": "sit",
    "freezeGame": "officia",
    "open": "dicta",
    "publish": "omnis",
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/templateproperties" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/templateproperties"
);
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"Template 1","user_properties":"sequi"}'
...
```bash
curl -X PUT \
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/templateproperties/placeat" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "https://api.evius.co/api/organizations/61fc3d08cc30801701328123/templateproperties/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/templateproperties/1/addtemplateporperties" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/users/603d6af041e6f468091c95d5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/users/603d6af041e6f468091c95d5"
);
...
```bash
curl -X DELETE \
    "https://api.evius.co/api/users/603d6af041e6f555591c95d5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/users/findByEmail/correo@evius.co" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/users/findByEmail/correo@evius.co"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/organization/61fc3d08cc30801701328123/users?filtered=%5B%7B%22field%22%3Anames%22%2C%22Evius%22%7D%5D&orderBy=%5B%7B%22field%22%3A%22_id%22%2C%22order%22%3A%22desc%22%7D%5D" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/organization/61fc3d08cc30801701328123/users"
);
...
```bash
curl -X PUT \
    "https://api.evius.co/api/users/voluptatum/changeStatusUser" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"status":"approved"}'
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"refreshlink":"ut","event":"61ccd3551c821b765a312864","email":"correo@evius.co"}'
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/singinwithemaillink" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
...
```javascript
const url = new URL(
    "https://api.evius.co/api/singinwithemaillink"
);
...
```bash
curl -X PUT \
    "https://api.evius.co/api/changeuserpassword" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"event_id":"61ccd3551c821b765a312864","email":"correo@evius.co"}'
...
```bash
curl -X POST \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/userproperties" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"celular","mandatory":true,"visibleByContacts":true,"visibleByAdmin":true,"label":"Celular","description":"N\u00famero de contacto","type":"number","justonebyattendee":true,"order_weight":1}'
...
```bash
curl -X DELETE \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/userproperties/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/userproperties" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
[
    {
        ...
        "mandatory": false,
        "type": "email",
        "updated_at": "2021-11-30 20:20:02",
        "created_at": "2021-11-30 20:20:02",
        "_id": "61a687723bbf847b3f59d11b",
        "author": null,
        "categories": [],
        "event_type": null,
        "organiser": null,
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/userproperties/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/userproperties/1/RegisterListFieldOptionTaken" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/eventusers/61a687713bbf847b3f59d117/makeTicketIdaProperty/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/eventusers/61a687713bbf847b3f59d117/makeTicketIdaProperty/1"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/events/61a687713bbf847b3f59d117/users/1/asignticketstouser" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/events/61a687713bbf847b3f59d117/users/1/asignticketstouser"
);
...
```bash
curl -X GET \
    -G "https://api.evius.co/api/contributors/events/61a687713bbf847b3f59d117" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "https://api.evius.co/api/contributors/events/61a687713bbf847b3f59d117"
);
...
```bash
curl -X POST \
    "https://api.evius.co/api/orders/non/validateFreeorder" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "https://api.evius.co/api/orders/1/validatePointOrderTest" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
